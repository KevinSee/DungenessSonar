...
ops_df |> 
  ...
  kable(booktabs = T,
        linesep = "",
        caption = "SONAR operational dates on the Dungeness River, 2018 - 2024.") |> 
  kable_styling(latex_options = c("hold_position"))


```

```{r op-fig, fig.height = 3.8, fig.width = 7, fig.cap = "Plot of when SONAR was operational (purple) and not (yellow), from January 1 through July 31 each year."}
half_hr_periods %>%
...
```{r review-fig, fig.height = 3.8, fig.width = 7, fig.cap = "Plot of when SONAR was reviewed (purple) and not (yellow), from January 1 through July 31 each year."}
half_hr_periods %>%
  mutate(hr = as.numeric(hour) / (60*60),
...
half_hr_periods |> 
  ...
  kable(col.names = c("Year",
        ...
        caption = "Number of hours during winter steelhead migration period (January 1 - June 15) and what percentage of those hours the SONAR was operational and what percentage of those hours have been reviewed.") |> 
  kable_styling(latex_options = c("HOLD_position"))
```
...
half_hr_periods |>
  ...
  kable(booktabs = T,
        linesep = "",
        format.args = list(big.mark = ","),
        caption = "The percentage of time between January and mid-June that the SONAR was operational, and how much of the total time was reviewed, 2018 - 2024.") |> 
  kable_styling(latex_options = c("hold_position"))
```
...
For `r paste(range(ts_half_hr$year), collapse = "-")`, SONAR fish targets that had a greater than or equal to 50% probability of being a steelhead, moved completely through the SONAR beams (direction of travel was upstream or downstream), and had a data reviewer confidence of 1 were included in the final steelhead counts and abundance estimate. Based in part on the species composition data, we determined that the steelhead run on the Dungeness is over by mid-June, so we restricted the steelhead season to SONAR observations or predictions between January 1 and June 15. 
...
# spp_comp |> 
  ...
  kable(booktabs = T,
        linesep = "",
        caption = "Counts of species encountered during species composition sampling in the lower Dungeness River in 2021-2024.") |> 
  kable_styling(latex_options = c("hold_position"))
```
...
spp_catch |> 
  ...
  kable(booktabs = T,
        ...
        align = "c",
        longtable = T,
        caption = "Counts of species encountered during species composition sampling in the lower Dungeness River in 2021 - 2024, with steelhead differentiated by mark status (marked (AD) or unmarked (UM)) and kelt status.") |> 
  ...
  row_spec(c(sum(spp_catch$year == 2021) + 1,
             ...
             sum(spp_catch$year %in% c(2021, 2022, 2023, 2024)) + 4),
           bold = T,
           hline_after = T) |>
...
yr_est |> 
  ...
  kable(col.names = c("Year",
        ...
        booktabs = T,
        linesep = "",
        caption = "Annual estimates of winter steelhead escapement to the Dungeness River between January 1 and June 15. Early (January 1- May 15), late (May 16 – June 15), total escapement estimate, standard error and range of the 95% confidence interval (CI).") |> 
  kable_styling(latex_options = c("scale_down",
                                  "hold_position")) |> 
  column_spec(c(2, 6, 10),
              bold = T) |> 
  add_header_above(c("",
                     "Early (Jan 1 - May 15)" = 4,
...
yr_est |>
  ...
  kable(col.names = c("Year",
        ...
        booktabs = T,
        linesep = "",
        caption = "Annual estimates of net escapemet of winter steelhead to the Dungeness River between January 1 and June 15.") |> 
  kable_styling(latex_options = c("scale_down",
                                  "hold_position"))
```
