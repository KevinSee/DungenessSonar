...
sonar_pred_spp |> 
  ...
  kable(col.names = c("Direction",
        ...
        linesep = "",
        # caption = "Test") |> 
        caption = "Number of fish observed moving downstream or upstream (n Fish), less than or greater than 67 cm, and whether they were likely (> 50\\% probability) to be a steelhead. Totals within each movement and size group are shown (n Sthd) as well as totals for each year by direction (Total Sthd).") |>
  kable_styling(latex_options = c("scale_down",
                                  "hold_position")) |> 
  collapse_rows(c(1)) |> 
  column_spec(c(9),
